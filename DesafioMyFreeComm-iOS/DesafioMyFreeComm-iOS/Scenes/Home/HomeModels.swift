  ...
  enum Something
  {
    ...
    struct Items : Codable {
        ...
        init(from decoder: Decoder) throws {
            ...
            private_item = try values.decodeIfPresent(Bool.self, forKey: .private_item)
            ...
            keys_urls_url = try values.decodeIfPresent(String.self, forKey: .keys_urls_url)
